...
Regarding the power consumption of the device in the previous work it was 110 mAh and now in the configuration mode is 100 mAh and in working mode with the encryption is the same 110 mAh as without encryption as in the previous work, 70 mAh of that comes from wifi-module.
...
[4] Fotios Chantzis, Ioannis Stais, Paulino Calderon, Evangelos Deirmentzoglou, Beau Woods. Practical IoT Hacking, The Definitive Guide to Attacking the Internet of Things. no starch press, 2021 (ISBN: 978-1718500907).
